                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                console.log("Dropdown trigger clicked for product:", product.id)
                              }}
                            >
                          ...
                          <DropdownMenuContent align="end" className="w-[160px]">
                            <DropdownMenuItem
                              onClick={(e) => {
                                e.stopPropagation()
                                if (product.id) handleViewProduct(product.id)
                              }}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={(e) => {
                                e.stopPropagation()
                                if (product.id) handleEditProduct(product.id)
                              }}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={(e) => {
                                e.stopPropagation()
                                if (product.id) handleDeleteProduct(product.id, product.name)
                              }}
